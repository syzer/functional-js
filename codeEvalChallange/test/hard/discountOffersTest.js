 ...
 *   that will allow us to offer exclusive discounts on various products to our top
 *   customers every day. The catch is that we can only offer each product to one
 *   customer and we may only offer one product to each customer.
 ...
 Fortunately, our team of highly skilled statisticians has developed an amazing
 mathematical model for determining how likely a given customer is to buy an
 offered product by calculating what we call the "suitability score" (SS).
 ...
 in a way that maximizes the combined total SS across all of the chosen offers.
 ...
 Each line in this file is one test case. Each test case will be a comma delimited
 set of customer names followed by a semicolon and then a
 comma delimited set of product names. Assume the input file is ASCII encoded.
...
var input2 =
    ...
    'Michael Bolton,Samir Nagheenanajar;Half & Half,Colt M1911A1,16lb bowling ball,' +
    'Red Swingline Stapler,Printer paper,Vibe Magazine Subscriptions - 40 pack';

var input3 =
    'Jareau Wade,Rob Eroh,Mahmoud Abdelkader,Wenyi Cai,Justin Van Winkle,Gabriel Sinkin,' +
    'Aaron Adelson;Batman No. 1,Football - Official Size,Bass Amplifying Headphones,' +
