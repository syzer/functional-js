...
var lib = require(SRC_DIR + 'gameOfLife');
...
describe('game of life', function () {
    ...
    it('can convert ot board', function (done) {
        var out = lib.convertToArray(inputSmall);
        expect(_.isArray(out)).eql(true);
        done();
    });

    it('finds Neighbours', function (done) {
        var out = lib.findNeighbours([4,1],lib.convertToArray(inputSmall));
        expect(_.isArray(out)).eql(true);
        expect(out.length).eql(5);
        done();
    });

    it('finds Alive Neighbours', function (done) {
        var out = lib.findAliveNeighbours([4,1],lib.convertToArray(inputSmall));
        expect(_.isArray(out)).eql(true);
