...
console.log(nonRecursive(function (x) {
    return 2;
})(100));// 200
...
var test = nonRecursive2(nonRecursive2)(5); // => 120
console.log(test);

function nonRecursive3(f) {
    return function (x) {
        var g = function (q) {           //lets get shit wrapped in a function g
            return function (n) {
...
var test2 = almostY(almostY)(5); // => 120
console.log(test2);

function Y(f) {
    var p = function (h) {       // pulling up p
        return function (x) {
            return f(h(h))(x);
        };
    };
...
var test4 = Y(nonRecursiveFibonacci)(10); // => 55
console.log("\n", test4);
